...
# MAGIC %md
# MAGIC ## Keeping the missing data
...
# MAGIC %md
# MAGIC Notice how the data remains as a null.

# COMMAND ----------

# MAGIC %md
# MAGIC ## Drop the missing data
# MAGIC 
...
# MAGIC %md
# MAGIC Usually you should specify what columns you want to fill with the subset parameter
...
df.fillna({"Name":"No Name","sales":0}).show()
...
# MAGIC %md
# MAGIC A very common practice is to fill values with the mean value for the column, for example:
...
# MAGIC %md
# MAGIC That is all we need to know for now!